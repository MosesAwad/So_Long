...
/*   Updated: 2023/11/15 21:09:19 by mawad            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc != 2)
		return (ft_printf("Please insert strictly 2 arguments!"), 1);
	fd = open(argv[1], O_RDONLY);
	if (fd == -1)
	{
		ft_printf("Error: couldn't open file (check file and/or folder name)");
		return (1);
	}
